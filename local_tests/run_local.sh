...
cp $BASE_DIR/tests/rmg/$eg/input.py $benchmark_tests/rmg_jobs/$eg/input.py
...
cp $BASE_DIR/tests/rmg/$eg/input.py $testing_tests/rmg_jobs/$eg/input.py
...
if [ $scoop_test == "yes" ]; then
	...
	cp $BASE_DIR/tests/rmg/$eg/input.py $testing_tests/rmg_jobs/$eg/scoop/input.py
